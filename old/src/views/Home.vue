...
==================================================-->
  ...
  <div class="swiper-container fade-slide">
    <div class="swiper-wrapper">
      <!-- a slide -->
      <div class="swiper-slide" style="background-image:url(@/assets/img/slider-4.jpg)">
    ...
    <div id="counter" class="top_90 counter">
      <div class="row">
        <div class="col-lg-4 col-md-4 count">
          ...
          <h4 class="title">SATISFACTION<br>CLIENTS</h4>
        </div>
        <div class="col-lg-4 col-md-4 count">
          <div class="counter-value" data-count="430">0</div>
          <h4 class="title">EMPLOYEES<br>ONWORLDWIDE</h4>
        </div>
        <div class="col-lg-4 col-md-4 count">
          <div class="counter-value" data-count="940">0</div>
          <h4 class="title">PROJECTS COMPLETEDON<br>60 COUNTRIES</h4>
        </div>
      </div> <!-- row end -->
    </div> <!-- counter end -->
  </div> <!-- container end-->
      ...
      <span>what the people saying about us</span>
          ...
          <div class="owl-carousel owl-theme testimonials" data-autoplay="true" data-items-desktop="3" data-items-desktop-small="3" data-items-tablet="2" data-items-tablet-small="1" data-margin="30">
            <!-- a comment -->
              <div class="item">
                <div class="outitem">
                  <figure><img src="@/assets/img/team-1.jpg" alt=""></figure>
                  <div class="name">
              ...
              <div class="item">
                  <div class="outitem">
                    <figure><img src="@/assets/img/team-2.jpg" alt=""></figure>
                    <div class="name">
              ...
              <div class="item">
                  <div class="outitem">
                    <figure><img src="@/assets/img/team-3.jpg" alt=""></figure>
                    <div class="name">
      ...
      <div class="row masonry clearfix">
          ...
          <a href="https://www.youtube.com/watch?v=M-M3rdL_WLQ" class="col-lg-4 col-sm-6 grid-item photography video-icon">
            <figure class="portfolio-item">
                  <img src="@/assets/img/works/work-1/01.jpg" alt="" />
              <figcaption>
          ...
          <a href="project-detail.html" class="col-lg-4 col-sm-6 grid-item branding link-icon">
            <figure class="portfolio-item">
                  <img src="@/assets/img/works/work-2/01.jpg" alt="" />
              <figcaption>
          ...
          <!-- a work -->
          <a href="@/assets/img/works/work-3/01.jpg" class="col-lg-4 col-sm-6 grid-item application lightbox-icon">
            <figure class="portfolio-item">
                  <img src="@/assets/img/works/work-3/01.jpg" alt="" />
              <figcaption>
          ...
          <!-- a work -->
          <a href="@/assets/img/works/work-4/01.jpg" class="col-lg-4 col-sm-6 grid-item photography lightbox-icon">
            <figure class="portfolio-item">
                  <img src="@/assets/img/works/work-4/01.jpg" alt="" />
              <figcaption>
          ...
          <!-- a work -->
          <a href="@/assets/img/works/work-5/01.jpg" class="col-lg-4 col-sm-6 grid-item branding lightbox-icon">
            <figure class="portfolio-item">
                  <img src="@/assets/img/works/work-5/01.jpg" alt="" />
              <figcaption>
          ...
          <!-- a work -->
          <a href="@/assets/img/works/work-6/01.jpg" class="col-lg-4 col-sm-6 grid-item webdesign lightbox-icon">
            <figure class="portfolio-item">
                  <img src="@/assets/img/works/work-6/01.jpg" alt="" />
              <figcaption>
...
<section class="newsletter imagebg text-center">
  <div class="container">
    ...
    <button type="submit" value="SEND" class="site-btn top_30">SUBSCRIBE</button>
  </div>
</section>
    ...
    <div  class="row">
      ...
      <div class="col-lg-4">
        <a class="anews" href="single-news.html">
          <div class="image" style="background-image:url(@/assets/img/news-1.jpg)"></div>
          <div class="date">
            <h3 class="big">23</h3>
      ...
      <div class="col-lg-4">
        <a class="anews" href="single-news.html">
          <div class="image" style="background-image:url(@/assets/img/news-2.jpg)"></div>
          <div class="date">
            <h3 class="big">26</h3>
            <span class="little">MARCH, 19</span>
          </div>
      ...
      <div class="col-lg-4">
        <a class="anews" href="single-news.html">
          <div class="image" style="background-image:url(@/assets/img/news-3.jpg)"></div>
          <div class="date">
            <h3 class="big">18</h3>
            <span class="little">MARCH, 19</span>
          </div>
...
<section id="contact" class="contact graybg">
  <div class="container wow fadeInUp">
      ...
      <div class="container wow fadeInUp">
        <!-- CLIENTS -->
        <ul class="bxslider">
          <li><img src="@/assets/img/clients/client-1w.png" alt="" /></li>
          <li><img src="@/assets/img/clients/client-2w.png" alt="" /></li>
          <li><img src="@/assets/img/clients/client-3w.png" alt="" /></li>
          <li><img src="@/assets/img/clients/client-4w.png" alt="" /></li>
          <li><img src="@/assets/img/clients/client-5w.png" alt="" /></li>
          <li><img src="@/assets/img/clients/client-6w.png" alt="" /></li>
          <li><img src="@/assets/img/clients/client-7w.png" alt="" /></li>
        </ul>
      </div>
